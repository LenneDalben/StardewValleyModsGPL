...
* SkippableConfig: Specify if you want all the events in the series to be skippable (true, false). Default is false. Useful for repeat playthroughs if you don't want the entire series to play, or if you're worried about getting stuck during an event due to a mod that changes maps.
